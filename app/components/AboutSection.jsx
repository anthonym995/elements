          ...
          <div className="w-full md:w-1/2 flex flex-col justify-start items-center text-left md:text-left">
            <div className="w-full">
              <header className="mb-6">
                <h2 className="text-[#333333] text-base font-semibold font-['Montserrat'] uppercase leading-tight">
                  About
                </h2>
                <h3 className="text-[#0e0e0e] text-2xl md:text-4xl font-bold font-['Montserrat'] leading-snug tracking-wider mt-2">
                  3 Elements Healthcare
                </h3>
              </header>
              <p className="text-[#999191] text-sm md:text-base font-normal font-['Roboto'] leading-relaxed mb-8 max-w-xl">
              ...
              <div>
                <a
                  href="/about"
                  className="px-7 py-3 bg-[#39b54a] text-white text-lg font-semibold font-['Roboto'] rounded-full"
                >
                  Read more...
                </a>
              </div>
